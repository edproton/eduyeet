...
// export default async function SessionSummaryCard({ userId }: SessionSummaryCardProps) {
// 	let sessionData
// 	try {
...
// 				</CardHeader>
// 				<CardContent>
// 					<p className="text-sm text-destructive">Failed to load session data</p>
// 				</CardContent>
// 			</Card>
// 		)
// 	}
...
// 						</dt>
// 						<dd className="mt-1 text-sm">{sessionData.lastLogin.toLocaleString()}</dd>
// 					</div>
// 					<div>
// 						<dt className="text-sm font-medium text-muted-foreground flex items-center">
