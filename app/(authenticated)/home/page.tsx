		...
		<Tabs defaultValue="students" className="space-y-4">
			...
			<TabsContent value="students" className="space-y-4">
				...
				<Card className="col-span-4">
					<CardHeader>
						...
						<CardDescription>Filter and view recent student bookings</CardDescription>
					</CardHeader>
					<CardContent>
						<div className="flex space-x-2 mb-4">
							<DropdownMenu>
								<DropdownMenuTrigger asChild>
									<Button variant="outline">
										Subject: {studentFilter.subject} <ChevronLeft className="ml-2 h-4 w-4" />
									</Button>
								</DropdownMenuTrigger>
								<DropdownMenuContent>
									<DropdownMenuItem
							...
							<DropdownMenu>
								<DropdownMenuTrigger asChild>
									<Button variant="outline">
										Status: {studentFilter.status} <ChevronLeft className="ml-2 h-4 w-4" />
									</Button>
								</DropdownMenuTrigger>
								<DropdownMenuContent>
									<DropdownMenuItem
			...
			<TabsContent value="tutors" className="space-y-4">
				<div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
					...
					<Card>
						<CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
							<CardTitle className="text-sm font-medium">Top Rated Subject</CardTitle>
							<BookOpen className="h-4 w-4 text-muted-foreground" />
						</CardHeader>
						<CardContent>
				...
				<Card className="col-span-4">
					<CardHeader>
						...
						<CardDescription>Filter and view top performing tutors</CardDescription>
					</CardHeader>
					<CardContent>
						<div className="flex space-x-2 mb-4">
							<DropdownMenu>
								<DropdownMenuTrigger asChild>
									<Button variant="outline">
										Subject: {tutorFilter.subject} <ChevronLeft className="ml-2 h-4 w-4" />
									</Button>
								</DropdownMenuTrigger>
								<DropdownMenuContent>
									<DropdownMenuItem
										onSelect={() => setTutorFilter({ ...tutorFilter, subject: 'All' })}
									>
										All
									</DropdownMenuItem>
									<DropdownMenuItem
							...
							<DropdownMenu>
								<DropdownMenuTrigger asChild>
									<Button variant="outline">
										Rating: {tutorFilter.rating} <ChevronLeft className="ml-2 h-4 w-4" />
									</Button>
								</DropdownMenuTrigger>
								<DropdownMenuContent>
									<DropdownMenuItem
										onSelect={() => setTutorFilter({ ...tutorFilter, rating: 'All' })}
									>
										All
									</DropdownMenuItem>
									<DropdownMenuItem
						...
						<Table>
							...
							<TableBody>
								<TableRow>
									<TableCell className="font-medium">Dr. Alex Johnson</TableCell>
								...
								<TableRow>
									<TableCell className="font-medium">Dr. Michael Brown</TableCell>
								...
								<TableRow>
									<TableCell className="font-medium">Prof. Emily White</TableCell>
